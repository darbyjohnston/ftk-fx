...
set(FX_TESTS ON CACHE BOOL "")

# The parts of tlRender this application will use: stills in, stills out, and
# colour management. Movies are off, which is most of the superbuild's time --
# FFmpeg and the AV1 encoders exist to play back plates, and this application
# renders passes rather than playing them.
#
# Turn TLRENDER_FFMPEG on the day a movie plate has to load behind the sim.
# Nothing else here has to change for that; it is one line and a rebuild of the
# dependencies.
